    ...
    public String analyzeMenuImage(File imageFile) {
        try {
            ...
            String promptText = "Распознай меню на картинке. Верни ответ СТРОГО в формате JSON. " +
                    ...
                    "ПРАВИЛО 3 (КБЖУ СЕТы): КБЖУ сет (например 'КБЖУ СЕТ 1' или 'КБЖУ СЕТ 2') это не отдельные позиции, каждая позиция это то что входит в состав сета, скомпилируй все в 1 позицию и установи для нее ценник который указан в заголовке. " +
                    "Никакого лишнего текста (включая лишние пробелы) или разметки markdown, только голый JSON.";
